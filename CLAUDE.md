...
- 上から：安心バッジの帯 → 題字（`img/title.jpg`）→ ひとこと → 科目の看板（押すと段へ飛ぶ・上に固定）→
  おすすめの段（えいごタイピング・げんしのへや・とどうふけん・百人一首・くく を再掲。札の左上に科目名）→ 科目ごとの段（さんすう／こくご／えいご／りか／しゃかい）→ おうちのかたへ（3つの約束・寄付・LINEスタンプ）
...
| `20_bunshi_no_heya/` | せかいのレシピ ぶんしのへや（原子の手をつないで分子20こ。見た目は 04 のCSSを写したもの） | 公開中 |
